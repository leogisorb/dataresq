  ...
  return (
    ...
    >
      <div className="site-container">
        ...
        <ul
          className={`${SECTION_CONTENT_MT} flex list-none items-stretch gap-3 overflow-x-auto pb-2 md:grid md:grid-cols-4 md:gap-4 md:overflow-visible md:pb-0 lg:mx-auto lg:max-w-[calc(4*340px+3*0.5rem)] lg:gap-2`}
        >
